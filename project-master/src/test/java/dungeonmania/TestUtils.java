...
public class TestUtils {
    ...
    public static Optional<EntityResponse> getOldPlayer(DungeonResponse res) {
        return getEntitiesStream(res, "old_player").findFirst();
    }

    public static List<EntityResponse> getEntitiesOfType(DungeonResponse res, String type) {
